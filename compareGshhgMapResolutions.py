...
pairs = [
    ...
    ("i", (0.0, 0.0, 1.0, 0.5)),            # intermediate
    ("h", (1.0, 1.0, 0.0, 0.5)),            # high
    ("f", (0.0, 1.0, 1.0, 0.5)),            # full
]
...
# Save figure ...
fg.savefig(
    "compareGshhgMapResolutions.png",
           dpi = 300,
    pad_inches = 0.1,
)
...
# Optimize PNG ...
pyguymer3.image.optimize_image("compareGshhgMapResolutions.png", strip = True)
